...
$config['admin_email']                = "example@mail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'member';           // Default group, use name

$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['team_group']             	  = 'team';             // Default administrators group, use name
$config['member_group']               = 'member';             // Default administrators group, use name
