...
class Skripsi extends Team_Controller
{
    ...
    {			
		...
		$config['base_url'] 					= site_url('team/skripsi/index/');
		...
		$this->load->view('team/skripsi/view/index', $this->data);
	}
	 ...
	 public function review($id)
    {
		...
		if($cek_skripsi->num_rows() > 0){
			...
			$this->load->view('team/skripsi/view/detail', $this->data);
		}else{
			redirect('team/skripsi', 'refresh');	
		}
    }
	...
	public function search()
    {
		...
		$view 							= $this->load->view('team/skripsi/lib/list_page', $this->data);
        return $view;
    }
