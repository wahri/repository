...
class User_member extends Team_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('team/user_member/view/index', $this->data);
    }
    ...
    public function delete($user_id = NULL)
    {
		if(is_null($user_id))
        {
			...
			if($user_id == $this->ion_auth->get_user_id()){
				$this->session->set_flashdata('success', 'Maaf data tidak dapat dihapus');
				redirect('team/user_member', 'refresh');
			}else{
    ...
    public function search()
    {
        ...
        $view = $this->load->view('team/user_member/lib/list_page', $this->data);
        return $view;
