...
class Home extends Team_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url']                     = site_url('team/home/index/');
        ...
        $this->load->view('team/home/index', $this->data);
    }

    public function notiv($id = NULL)
    {
        if($id == NULL){
            redirect('team/home', 'refresh');
        }else{
            ...
            if($cek_data->num_rows() > 0){
                ...
                redirect('team/'.$cek_data->row()->notiv_url, 'refresh');
            }else{
                redirect('team/home', 'refresh');
            }
        }
