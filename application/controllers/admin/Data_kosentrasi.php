...
class Data_kosentrasi extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$config['base_url'] 					= site_url('admin/data_kosentrasi/index/');
		...
		$this->load->view('admin/kosentrasi/view/index', $this->data);
    }
	...
	public function add(){
		...
		if ($this->form_validation->run() === TRUE) {
			...
			redirect('admin/data_kosentrasi', 'refresh');
			...
			$this->load->view('admin/kosentrasi/add/index', $this->data);
		}
	...
	public function edit($id = NULL){
		...
		if($cek_data->num_rows() > 0){
			...
			if ($this->form_validation->run() === TRUE) {
				...
				$this->data['message'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message')));
				$this->load->view('admin/kosentrasi/edit/index', $this->data);
			}
		
		}else{
			$this->session->set_flashdata('success', 'Maaf data tidak dapat diubah');
			redirect('admin/kosentrasi', 'refresh');
		}
	}
    ...
    public function search()
    {
        ...
        $view = $this->load->view('admin/kosentrasi/lib/list_page', $this->data);
        return $view;
    }
