...
class Data_dosen extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$config['base_url'] 					= site_url('admin/data_dosen/index/');
		...
		$this->load->view('admin/dosen/view/index', $this->data);
    }
	...
	public function add(){
		...
		if ($this->form_validation->run() === TRUE) {
			...
			redirect('admin/data_dosen', 'refresh');	
			...
			$this->load->view('admin/dosen/add/index', $this->data);
		}
	...
	public function edit($id = NULL){
		...
		if($cek_data->num_rows() > 0){
			...
			if ($this->form_validation->run() === TRUE) {
				...
				$this->load->view('admin/dosen/edit/index', $this->data);
			}
    ...
    public function search()
    {
		...
		$view 						= $this->load->view('admin/dosen/lib/list_page', $this->data);
        return $view;
    }
