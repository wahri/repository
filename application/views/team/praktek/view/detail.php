        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
			 ...
			 <form id="formUploadFitur"  action="<?php echo url_web('team/praktek/edit/'.$skripsi->id); ?>" method="post" enctype="multipart/form-data">
					  ...
					  <div class="row no-print">
                        <div class="col-xs-12">
						 <div class="ln_solid"></div>
                          <a href="<?php echo base_url('team/praktek'); ?>" class="btn btn-default" >Kembali</a>
