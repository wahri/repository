...
<div class="container">    
  <div class="row">
    <div class="col-sm-12">
     ...
     <p>We would like to congratulate you for the acceptance of your abstract <b>“<?php if(isset($email_paper)) { echo $email_paper; }?>“</b>. Please proceed to the next step which is to upload full paper through your account.</p>
	 <p>At this stage, we also strongly encourage you to make payment (early bird) that can be done to:</p>
