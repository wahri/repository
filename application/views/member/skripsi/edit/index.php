...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
			<form id="formUploadFitur"  action="<?php echo url_web('member/skripsi/edit/'.$id); ?>" method="post" enctype="multipart/form-data">
			<!-- Smart Wizard -->
					...
					<div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <div id="step-1">
						...
						<div class="form-horizontal form-label-left">
						  ...
						  <div class="form-group">
                            <label for="pem_dua" class="control-label col-md-3 col-sm-3 col-xs-12">Pembimbing 2 <span class="required">*</span></label>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <select class="form-control" name="pem_dua" id="pem_dua">
								<option value="">- pilihan -</option>
								<?php 
								foreach($data_dosen as $rr_dosen){
									if($pem_dua == $rr_dosen->id){
										echo '<option value="'.$rr_dosen->id.'" selected>'.$rr_dosen->nama.'</option>';
									}else{
										echo '<option value="'.$rr_dosen->id.'">'.$rr_dosen->nama.'</option>';
									}
								}
								?>
							  </select>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Seminar Komprehensif <span class="required">*</span>
                            </label>
                    ...
                    <div id="step-3">
						...
						<div class="form-horizontal form-label-left">	
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="karya">Jurnal <span class="required">*</span>
								</label>
								<div class="col-md-4 col-sm-6 col-xs-12">
									<input id="jurnal" class="form-control col-md-7 col-xs-12" type="file" name="jurnal">
									<p class="help-block">Upload Jurnal, tipe file PDF</p>
								</div>
							</div>
							
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="karya">Dokumen Skripsi <span class="required">*</span>
								</label>
								<div class="col-md-4 col-sm-6 col-xs-12">
									<input id="doc_skripsi" class="form-control col-md-7 col-xs-12" type="file" name="doc_skripsi">
									<p class="help-block">Upload Dokumen lengkap skripsi, tipe file PDF</p>
								</div>
							</div>
							
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="karya">Aplikasi <span class="required">*</span>
								</label>
								<div class="col-md-4 col-sm-6 col-xs-12">
									<input id="aplikasi" class="form-control col-md-7 col-xs-12" type="file" name="aplikasi">
									<p class="help-block">Upload Aplikasi / Sources Program + (database)/ software pendukung, compress ke tipe file RAR</p>
								</div>
							</div>
						</div>
                    </div>
