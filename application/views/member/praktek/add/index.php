...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
			<form id="formUploadFitur"  action="<?php echo url_web('member/praktek'); ?>" method="post" enctype="multipart/form-data">
			<!-- Smart Wizard -->
                      ...
                      <div id="step-1">
						...
						<div class="form-horizontal form-label-left">
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="karya">Jenis Kerja Praktek <span class="required">*</span>
                            </label>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Judul Kerja Praktek <span class="required">*</span>
                            </label>
						  ...
						  <div class="form-group">
                            <label for="pem_satu" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Pembimbing<span class="required">*</span></label>
                            <div class="col-md-4 col-sm-6 col-xs-12">
...
$(document).ready(function(){
    ...
    function validateSteps(stepnumber){
        ...
        // validate step 1
        if(stepnumber == 1){
			$('#karya,#judul,#penulis,#pem_satu,#subtanggal_start').each(function () {
                if ($.trim($(this).val()) == '') {
                    isStepValid = false;
                    $(this).css({
    ...
    function validateAllSteps(){
		...
		//alert('valid finis');
        $('#bab_satu,#doc_skripsi').each(function () {
			if ($.trim($(this).val()) == '') {
				isStepValid = false;
				$(this).css({
					"border": "1px solid red",
