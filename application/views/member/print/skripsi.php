...
web: informatika.umri.ac.id</small></p><hr/>
        ...
        <section class="content invoice">
          <div class="row">
              <div class="col-xs-12 invoice-header">
                <h2>FORMULIR UPLOUD KARYA TUGAS AKHIR</h2>
              </div>
              <div class="col-sm-12">
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>a. Jenis Karya Ilmiah </td>
                      <td>:&nbsp;</td>
                      <td>Skripsi</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>b. Konsentrasi Karya</td>
                      <td>:&nbsp;</td>
                      <td><?php echo $this->costume->get_name_kosentrasi($skripsi->kosentrasi); ?></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>c. Judul Karya</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>b. Pembimbing 1</td>
                      <td>:&nbsp;</td>
                      <td><?php echo $this->costume->get_name_dosen($skripsi->pembimbing_1)->nama; ?></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>b. Pembimbing 2</td>
                      <td>:&nbsp;</td>
                      <td><?php echo $this->costume->get_name_dosen($skripsi->pembimbing_2)->nama; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Dokumen Skripsi.pdf</td>
                      <td>:</td>
                      <td>&#10004;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Dokumen Aplikasi.rar</td>
                      <td>:</td>
                      <td>&#10004;</td>
                    </tr>
                  </tbody>
                ...
                <p>Formulir ini merupakan bukti resmi yang dikeluarkan secara otomatis oleh Sistem Repositori Teknik Informatika (SEPORTIF), setelah mahasiswa menyelesaikan penggugahan dokumen Tugas Akhir.</p>
                </br>
          ...
          <div class="row">
              <div class="col-sm-12">
                <a href="<?php echo url_web('member/skripsi'); ?>" class="btn btn-success pull-right noprint"><i class="fa fa-credit-card"></i> kembali</a>
