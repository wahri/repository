	...
	?>
        <tr class="even pointer list-baris-article">
			<td>
				...
				?>
				<br>
				<small style="font-size:11px">Kosentrasi: <?php echo $this->costume->get_name_kosentrasi($lists_paper->kosentrasi); ?></small>
			</td>
			...
			<td style="font-size:11px">
				Pembimbing 1 : <?php echo $this->costume->get_name_dosen($lists_paper->pembimbing_1)->nama; ?>
				</br>
				Pembimbing 2 : <?php echo $this->costume->get_name_dosen($lists_paper->pembimbing_2)->nama; ?>
			</td>
            ...
            <td>
				<a href="<?php echo url_web('admin/skripsi/review/').$lists_paper->id; ?>" class="btn btn-xs btn-default">Detail</a>
			</td>
